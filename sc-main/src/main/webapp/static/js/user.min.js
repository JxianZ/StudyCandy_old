...
function successCheck() {
    ...
    if (
        $("#inputrealname").parent().parent().hasClass("has-success")
        &&$("#usercodeinput").parent().parent().hasClass("has-success")
        &&$("#phoneinput").parent().parent().hasClass("has-success")
        &&$("#inputuserid").parent().parent().hasClass("has-success")
    )
    {
        $("#part1now").removeClass("disabled");
        $("#part1next").removeClass("disabled");
