...
$(function () {
   ...
   /* username end */
    ...
    $("#part1now, #part2now").click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function(r){
                            if(r.status==0){
                                ...
                                $("#reg-nav2").removeClass("reg-nav-on");
...
$(function(){
    ...
    $("#part2re").click(function () {
        $("#reg-nav2").removeClass("reg-nav-on");
        $("#reg-nav1").addClass("reg-nav-on");
        $(".reg-part1").toggle();
        $(".reg-part2").toggle();
    });
    /* userid start */
});
/* reg-part2-function end */